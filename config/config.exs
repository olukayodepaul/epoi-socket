...
config :dart_messaging_server, :processor_state,
  ...
  force_change_seconds: 60 * 2     # Force a rebroadcast every 1 min idle

config :dart_messaging_server, :monitor_state,
  stale_threshold_seconds: 60 * 2,   # 60 * 20 User considered stale after 10 min no device activity
